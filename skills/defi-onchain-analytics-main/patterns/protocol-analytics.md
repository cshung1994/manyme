...
- [ ] **Pre-attack context checked for incident analysis?** When investigating an exploit or anomaly, check TVL trajectory (30-90 days prior), large withdrawals by privileged addresses in the 72h before the incident, and any unusual governance/parameter changes. Escalate to full insider/governance analysis if anomalies found. Skipping this misses preparation signals and insider-knowledge indicators.
